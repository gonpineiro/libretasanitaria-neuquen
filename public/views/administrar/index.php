        ...
        <div class="form-group">
            <div class="form-group col-12">
                <div class='col-sm d-flex justify-content-center'>
                    <button type="button" onclick='window.location.replace("./nuevas_solicitudes.php")' class="btn btn-primary btn-lg" style="background-color: #109AD6;min-width:250px">Nuevas Solicitudes</button>
                </div>
            </div>
            <div class="form-group col-12">
                <div class='col-sm d-flex justify-content-center'>
                    <button type="button" onclick='window.location.replace("./historial_solicitudes.php")' class="btn btn-primary btn-lg" style="background-color: #109AD6;min-width:250px">Historial Solicitudes</button>
                </div>
            </div>
        </div>
    </div>

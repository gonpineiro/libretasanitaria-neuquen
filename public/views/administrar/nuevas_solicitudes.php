                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td class="date"><?= $sol['fecha_alta_sol'] ?></td>
                            <td class="company">-</td>
                            <td class="text-center"><a href="#"><i class="bi bi-printer-fill print_card"></i></a></td>
                        </tr>
                    <?php } ?>
                </tbody>
            </table>
                        ...
                        <div class="card card flex-row flow flex-wrap">
                            ...
                            <div class="card-block w-100 pb-3 container">
                                <div class="collapse" id="capacitacion">
                                    ...
                                    <p class="card-text" style="margin-bottom:0rem;">Lugar Capacitaci&oacute;n: </p>
                                    <p class="card-text" style="margin-bottom:0rem;">Fecha Capacitaci&oacute;n: </p>
...
<script>
    ...
    function imprimirLibreta() {
        // parra obtener el id de la fila = const idReferencia = node.currentTarget.parentNode.id
        $.ajax({
            url: "getDatosLibreta.php",
            type: "POST",
            data: {
            ...
            success: function(response) {
                ...
                var numeroLibreta = "N°: " + dni;
                var tipoEmpleo = data.tipo_empleo ? "CON Manipulación Alimentos" : "SIN Manipulación Alimentos";
                var observaciones = "skdjhaskjdhakjdhaskjdhkjashdkhaKDJHASKDHASKDHKJAhdkashdkjahsdasjkdhaks";
                // var observaciones = data.observaciones ? data.observaciones : "No presenta";
                var observaciones = observaciones.substring(0, 40);
                imprimirPdf(fotodni, nombre, dni, domicilio, fechaNacimiento, fechaExpedicion, fechaVencimiento, tipoEmpleo, observaciones);

...
<script>
    ...
    function imprimirPdf(fotodni, nombre, dni, domicilio, fechaNacimiento, fechaExpedicion, fechaVencimiento, tipoEmpleo) {
        ...
        var numeroLibreta = "24.413.486";
        var tipoEmpleo = "CON MANIP.DEALIMENT";
        var doc = new jsPDF("p", "mm", "a4");
        doc.setDrawColor(0);
        // rectángulo de ambas caras con el color de fondo
        // referencia de las propiedades de las figuras (posición eje horizontal, posición eje vertical, ancho, alto)
        doc.setFillColor(247, 247, 247);
        doc.rect(20, 20, 100, 35, "F");
        // rectángulo izquierdo de la libreta
        doc.rect(20, 20, 50, 35);
        // rectángulo derecho de la libreta
        doc.rect(70, 20, 50, 35);
        doc.setTextColor(50);
        doc.setFontSize(8);
        // referencia de la posición de los textos (posición eje horizontal, posición eje vertical)
        doc.text(35, 52, "Libreta Sanitaria");
        doc.setFontSize(4.5);
        doc.text(36, 33, "Apellido y Nombre:");
        doc.setFontSize(5);
        doc.text(36, 35, nombre);
        doc.setFontSize(4.5);
        doc.text(36, 37, "Domicilio:");
        doc.setFontSize(5);
        doc.text(36, 39, domicilio);
        doc.setFontSize(5);
        doc.text(36, 41, "DNI: " + dni);
        doc.setFontSize(5);
        doc.text(36, 43, "Fecha Nacimiento: " + fechaNacimiento);
        doc.setFontSize(5);
        doc.text(36, 45, "Fecha Expedición: " + fechaExpedicion);
        doc.setFontSize(5);
        doc.text(36, 47, "Fecha Vencimiento: " + fechaVencimiento);
        doc.setFontSize(8);
        doc.text(78, 26, "Municipalidad de Neuquén");
        doc.setFontSize(6);
        doc.text(84, 29, "Provincia de Neuquén");
        doc.setFontSize(6);
        doc.text(77, 33, "LIBRETA SANITARIA N° " + numeroLibreta);
        doc.setFontSize(4);
        doc.text(74, 36, "Observaciones:");
        doc.setFontSize(4);
        doc.text(74, 39, " " + observaciones);
        doc.addImage(banner, "JPEG", 20.5, 20.35, 49, 7);
        doc.addImage(fotodni, "JPEG", 22, 31, 12.8, 16);
